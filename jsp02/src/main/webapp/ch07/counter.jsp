...
long visit_time=0;//String타입으로 return받은 방문시각을 계산할 수 있는 변수로 준비

//방문시각(visitTime)이 null아니고 빈문자열이 아니면 즉, 값이있으면
...
if(count==null || count.equals("")){//첫 방문일 경우
  //쿠키변수 생성:첫 방문일 때 count변수에 초기값 1을 줌
