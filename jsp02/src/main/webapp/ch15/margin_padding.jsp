...
<body>
 ...
 <div class="container mt-3">
  ...
  <div class="d-flex bd-highlight mb-3">
   <div class="p-2 bg-info">기본값(자동 여백 없음)</div>
   <div class="p-2 bg-warning">기본값(자동 여백 없음)</div>
   <div class="p-2 bg-primary">기본값(자동 여백 없음)</div>
  </div>
  <div class="d-flex bd-highlight mb-3">
   <div class="me-auto p-2 bg-info">두항목을 오른쪽으로 밀기(.me-auto)</div>
   <div class="p-2 bg-warning">기본값(자동 여백 없음)</div>
   <div class="p-2 bg-primary">기본값(자동 여백 없음)</div>
  </div>
  <div class="d-flex bd-highlight mb-3">
   <div class="p-2 bg-info">기본값(자동 여백 없음)</div>
   <div class="p-2 bg-warning">기본값(자동 여백 없음)</div>
   <div class="ms-auto p-2 bg-primary">두항목을 왼쪽으로 밀기(.ms-auto)</div>
  </div>
 </div>
