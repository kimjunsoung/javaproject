...
<div class="container">
 ...
 <div class="border d-flex bg-info">
  ...
  <div class="border bg-secondary">영역2 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-warning">영역3 - 긴글 긴글 긴글 긴글 </div>
 </div>
 <p>flex-wrap 속성을 주면 block으로 전환되면서 영역이 줄바꿈되고 웹브라우저의 크기에
 따라서 줄바꿈여부가 결정된다.</p>
...
<div class="container">
 ...
 <p>a) 요소들이 높이 200px 전체 적용</p>
 <div class="border d-flex flex-wrap bg-info" style="height: 200px">
  <div class="border bg-primary">영역1 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-secondary">영역2 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-warning">영역3 - 긴글 긴글 긴글 긴글 </div>
 </div>
 ...
 <p>d) align-content-center: 요소들이 가운데 배치된다.</p>
 ...
 <p>f) align-content-stretch: 부모요소에서 높이가 꽉차게 줄바꿈(노옵션과 마찬가지)</p>
...
<div class="container">
 ...
 <div class="border d-flex flex-wrap align-items-start bg-info"
  style="height: 200px;">
  <div class="border bg-primary">영역1 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-secondary">영역2 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-warning">영역3 - 긴글 긴글 긴글 긴글 </div>
 ...
 <div class="border d-flex flex-wrap align-items-end bg-info"
  style="height: 200px;">
  <div class="border bg-primary">영역1 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-secondary">영역2 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-warning">영역3 - 긴글 긴글 긴글 긴글 </div>
 ...
 <div class="border d-flex flex-wrap align-items-center bg-info"
  style="height: 200px;">
  <div class="border bg-primary">영역1 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-secondary">영역2 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-warning">영역3 - 긴글 긴글 긴글 긴글 </div>
 ...
 <div class="border d-flex flex-wrap align-items-baseline bg-info"
  style="height: 200px;">
  <div class="border bg-primary">영역1 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-secondary">영역2 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-warning">영역3 - 긴글 긴글 긴글 긴글 </div>
 ...
 <div class="border d-flex flex-wrap align-items-stretch bg-info"
  style="height: 200px;">
  <div class="border bg-primary">영역1 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-secondary">영역2 - 긴글 긴글 긴글 긴글 긴글 긴글 긴글 긴글 </div>
  <div class="border bg-warning">영역3 - 긴글 긴글 긴글 긴글 </div>
...
<div class="border d-inline-flex bg-info" style="height: 200px;">
 ...
 <div class="border align-self-baseline bg-danger">baseline</div>
